...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 155085.8487769919; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 96421.2662119683; // x position of the perpendicular encoder (in tick units)
    }
    ...
    public PinpointLocalizer(HardwareMap hardwareMap, double inPerTick, Pose2d initialPose) {
        ...
        double mmPerTick = 25.4 * MecanumDrive.PARAMS.inPerTick;
